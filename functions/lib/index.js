...
exports.subscribeTopic = functions.https.onRequest((req, res) => {
    corsHandler(req, res, () => {
...
exports.inviteChatroom = functions.https.onRequest((req, res) => {
    corsHandler(req, res, () => {
        const uid = req.body.uid;
...
exports.messageTopic = functions.https.onRequest((req, res) => {
    corsHandler(req, res, () => {
        const topic = req.body.topic;
...
exports.tradeNotification = functions.https.onRequest((req, res) => {
    corsHandler(req, res, () => {
...
exports.unsubscribeTopic = functions.https.onRequest((req, res) => {
    corsHandler(req, res, () => {
        const uid = req.body.uid;
